...
//    private String DELIMITER = "/";
    ...
    public ReportGenerator(Map<File, Set<String>> fileMap,
        ...
        if (fileMap == null || totalFileMap == null || correctDatasetMap == null || detailedDatasetMap == null || listener == null) {
    ...
    public Void call() throws Exception {
        ...
        try {
            ...
            drawTable(page1, contentStream, 700, 50, packStatisticForFile());
            contentStream.close();

            contentStream = new PDPageContentStream(doc, page2);
            drawTable(page2, contentStream, 700, 50, packStatisticForData());
            contentStream.close();
            ...
            for (String line : packStatisticForTime()) {
    ...
    /**
     * A method to pack statistics for the files
     * @return the String 2D matrix containing all the data in report
     */
    private String[][] packStatisticForFile() {

        // categorize the files
        Map<String, Integer> fileWithData = new HashMap<>();
        for (Map.Entry<File, Set<String>> entry : fileMap.entrySet()) {
            String type = Utility.getExtension(entry.getKey().getName());
        ...
        for (String datatype : detailedDatasetMap.keySet()) {
            ...
            for (String data : correctDatasetMap.get(datatype)) {
                for (List<String> metadata : detailedData.get(data)) {
                    ...
                    String type = Utility.getExtension(path);
                    marks.add(path);
    ...
    /**
     * A method to pack statistics for data
     * @return the String 2D matrix containing all the data in report
     */
    private String[][] packStatisticForData() {
        ...
        return contentForData;
    }


    /**
     * A method to pack statistics for time it takes for scanning, matching, evaluation
     * @return the list of statistics showing in the report
     */
    private List<String> packStatisticForTime() {
